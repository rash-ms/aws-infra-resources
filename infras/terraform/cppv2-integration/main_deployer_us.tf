...
# resource "aws_cloudwatch_metric_alarm" "userplatform_cpp_eventbridge_failed_invocations_us" {
#   alarm_name  = "Userplatform-CPP-EventBridge-Failed-Invocations-US"
#   namespace   = "AWS/Events"
#   metric_name = "FailedInvocations"
#   dimensions = {
#     RuleName     = aws_cloudwatch_event_rule.userplatform_cpp_eventbridge_to_firehose_rule_us.name
