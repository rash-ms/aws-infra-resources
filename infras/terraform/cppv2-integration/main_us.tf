...
#       enabled         = true
#       log_group_name  = "aws_cloudwatch_log_group" "userplatform_cpp_firehose_to_s3_logs.name"
#       log_stream_name = "aws_cloudwatch_log_stream.userplatform_cpp_firehose_to_s3_log_stream.name"
#     }
#
...
# }
#
# resource "aws_cloudwatch_log_group" "userplatform_cpp_firehose_to_s3_logs" {
#   name              = "/aws/kinesisfirehose/userplatform_cpp_firehose_to_s3_us"
#   retention_in_days = 30
# }
#
# resource "aws_cloudwatch_log_stream" "userplatform_cpp_firehose_to_s3_log_stream" {
